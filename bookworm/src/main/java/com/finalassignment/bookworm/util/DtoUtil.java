...
public class DtoUtil {
    ...
    public static AdminDto fromAdmin(final Admin admin) {
        ...
        return AdminDto.builder().adminContactNumber(admin.getAdminContactNumber())
                .adminEmail(admin.getAdminEmail()).adminId(admin.getAdminId())
...
//        bookInventoryDto.setInventoryId(bookInventory.getInventoryId());
...
//        issuedBooksDto.setIssueId(issuedBooks.getIssueId());
...
//        userLibraryCardDto.setCardId(userLibraryCard.getCardId());
    ...
    public static UserLibraryCard fromUserLibraryCardDto(final UserLibraryCardDto userLibraryCardDto) {
        ...
        userLibraryCard.setUser(fromUserDto(userLibraryCardDto.getUser()));
